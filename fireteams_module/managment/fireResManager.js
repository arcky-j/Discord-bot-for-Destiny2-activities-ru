...
class FireteamsResManager extends DiscManager{

    constructor(clan){
        super();
        this.clan = clan;
        this.path = path.join(this.basePath, 'clans', `clan_${clan.id}`, 'activities', 'fireteamsRes');
        if (!fs.existsSync(this.path)){
            fs.mkdirSync(this.path, {recursive:true});
            console.log(`Директория data/clans/clan_${clan.id}/activities/fireteamRes была успешно создана.`);
        }
    }
...
module.exports = FireteamsResManager;